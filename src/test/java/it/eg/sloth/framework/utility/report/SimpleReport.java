...
public class SimpleReport extends BaseXlsxWriter {
    ...
    public void addData() {
        ...
        setRangeStyle(row, 0, row, 2, getStyle(BaseExcelContainer.WHITE_BORDERED_BOTTOM, BaseExcelFont.TITLE, null, HorizontalAlignment.LEFT, true));
        addMergedRegion(row, 0, row, 2);
        row++;

        // Data - Livello 1
        setCellStyle(row, 1, BaseExcelContainer.WHITE_BORDERED, BaseExcelFont.HIGHIGHTED, null, HorizontalAlignment.LEFT, true);
        setCellValue(row, 1, "Data 1");

        setCellStyle(row, 2, BaseExcelContainer.WHITE_BORDERED, null, null, HorizontalAlignment.LEFT, true);
        ...
        setRangeStyle(row, 1, row, 2, getStyle(BaseExcelContainer.WHITE_BORDERED_BOTTOM, BaseExcelFont.SUB_TITLE, null, HorizontalAlignment.LEFT, true));
