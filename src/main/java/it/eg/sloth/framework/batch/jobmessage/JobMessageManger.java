...
public interface JobMessageManger {
    ...
    JobMessage updateMessage(Integer executionId, JobMessageSeverity severity, String message, String detail, int progress, JobStatus status) throws FrameworkException;
