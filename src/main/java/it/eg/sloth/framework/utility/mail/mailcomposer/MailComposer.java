...
import it.eg.sloth.framework.utility.mail.mailcomposer.elements.Bullet;
import it.eg.sloth.framework.utility.mail.mailcomposer.elements.BulletList;
import it.eg.sloth.framework.utility.mail.mailcomposer.elements.EmbeddedImage;
import it.eg.sloth.framework.utility.mail.mailcomposer.elements.Line;
...
import it.eg.sloth.framework.utility.mail.mailcomposer.elements.TableRow;
...
public abstract class MailComposer extends FrameComponent {
  ...
  public EmbeddedImage addEmbeddedImage(File image, String name, String type, String link) throws FileNotFoundException, IOException {
    EmbeddedImage result = new EmbeddedImage(image, name, type, link);
    elements.add(result);
