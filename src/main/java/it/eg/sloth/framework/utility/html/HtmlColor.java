...
public class HtmlColor {
  ...
  public static final String DARK = "#5a5c69";

  private static final List<String> COLOR_1 = Arrays.asList(PRIMARY, WARNING, DANGER, SUCCESS, SECONDARY, INFO, DARK);
  ...
  public static List<String> getColorPalette(int size) {
    if (size <= COLOR_1.size()) {
      return COLOR_1;
    } else if (size <= COLOR_2.size()) {
      return COLOR_2;
    } else {
